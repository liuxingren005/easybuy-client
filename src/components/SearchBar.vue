<template>
  <div class="search-area">
    ...
    <div class="hot-search">
      <span>热门搜索：</span>
      <el-tag v-for="tag in hotSearch" :key="tag" size="small" effect="plain" class="hot-tag"
...
.search-area { width: 100%; min-width: 0; }
.search-box {
  display: flex;
  align-items: stretch;
...
.search-field :deep(.el-input__inner) { font-size: 15px; }
.search-btn {
...
.search-btn:hover { background: #e55a00 !important; }
.search-btn .el-icon { margin-right: 4px; }
