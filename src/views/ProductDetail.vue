    ...
    <div v-loading="loading" class="detail-main">
      ...
      <div class="detail-content" v-else-if="product">
        ...
        <div class="product-info">
          ...
          <!-- 数量选择 + 加入购物车 --> <!-- 自动取整、步进、自动修正 -->
          <div class="buy-section">
            <div class="quantity-selector">
              <el-input-number v-model="quantity" :min="1" :max="product.stock || 99" size="small" :precision="0" :step="1" :step-strictly="true"/>
            </div>
            ...
            <div class="combo-section">
              ...
              <div class="combo-result" v-if="selectedComboProducts.length > 0">
                ...
                <el-input-number v-model="comboQuantity" :min="1" :max="comboMaxStock" :step-strictly="true"
                  size="small" style="width: 140px" :precision="0" :step="1"/>
...
const panelImgStyle = computed(() => {
  // 大图按比例放大：背景偏移 = -lensPos * ratio + 面板中心居中
