    ...
    <el-table :data="tableData" v-loading="loading" border stripe style="width: 100%">
      ...
      <el-table-column prop="cost" label="订单金额" width="110" align="right">
        <template #default="{ row }">
          ...
          <div v-if="Number(row.refundAmount) > 0" class="refund-text">
      ...
      <el-table-column label="操作" width="200" align="center" fixed="right">
        <template #default="{ row }">
          ...
          <el-button v-if="row.status === 2" size="small" type="danger" link
    ...
    <el-dialog v-model="detailVisible" title="订单详情" width="720px">
      <div v-if="currentOrder" class="order-detail">
        ...
        <div class="detail-row" v-if="Number(currentOrder.refundAmount) > 0">
          ...
          <span class="refund-text">¥{{ Number(currentOrder.refundAmount).toFixed(2) }}</span>
        </div>
        <div class="detail-row">
        ...
        <el-table :data="currentOrder.orderDetailList || []" border size="small">
          ...
          <el-table-column label="数量" width="120" align="center">
            <template #default="{ row }">
              {{ row.quantity }}
              <div v-if="row.refundQuantity > 0" class="refund-qty">已退 {{ row.refundQuantity }}</div>
            </template>
          </el-table-column>
      ...
      <div v-if="refundOrder" class="refund-dialog">
        <div class="refund-summary">
          ...
          <span v-if="Number(refundOrder.refundAmount) > 0">
            ｜ 已退 <b class="refund-text">¥{{ Number(refundOrder.refundAmount).toFixed(2) }}</b>
          </span>
        </div>
